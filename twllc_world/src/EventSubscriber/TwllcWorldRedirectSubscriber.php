...
namespace Drupal\twllc_world\EventSubscriber;
 ...
 */
class TwllcWorldRedirectSubscriber implements EventSubscriberInterface {
  ...
  public function onRequest(GetResponseEvent $event) {
    ...
    if ($route_name !== 'twllc_world.hello') {
      return;
    }

    $roles = $this->currentUser->getRoles();
    if (in_array('non_grata', $roles)) {
      $url = Url::fromUri('internal:/course');
