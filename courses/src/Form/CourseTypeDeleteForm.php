...
/**
 * Description of CourseTypeDeleteForm
 *
 * @author arthur
 */
...
class ProductTypeDeleteForm extends EntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.course_type.collection');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger->addMessage($this->t('Deleted @entity course type.', ['@entity' => $this->entity->label()]));
